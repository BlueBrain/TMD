...
from tmd.io.swc import swc_data_to_lists
from tmd.io.h5 import read_h5
from tmd.io.h5 import h5_data_to_lists
...
def load_neuron(input_file, line_delimiter='\n', tree_types={}):
    ...
    offset = _np.transpose(data)[0][0]

    p = _np.array(_np.transpose(data)[6], dtype=int) - offset
...
def load_population(input_directory, tree_types={}):
