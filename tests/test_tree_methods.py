...
tree_h5 = neu3.axon[0]
tree_h5_ap = neu3.apical_dendrite[0]
tree0 = neu1.neurites[0]
tree1 = neu1.neurites[1]

secs_h5_beg = np.array(
    [
        0,
        16,
        17,
...
secs_h5_beg_ap = np.array([0, 4, 5, 8, 9, 20, 33, 109, 109, 33, 20, 9, 8, 213, 213, 5, 4])

secs_h5_end_ap = np.array(
    [4, 5, 8, 9, 20, 33, 109, 121, 130, 143, 176, 205, 213, 225, 251, 267, 292]
)

secs_h5_beg_points_ap = np.array(
    [0, 5, 6, 9, 10, 21, 34, 110, 122, 131, 144, 177, 206, 214, 226, 252, 268]
)

secs_h5_end_points_ap = np.array(
    [4, 5, 8, 9, 20, 33, 109, 121, 130, 143, 176, 205, 213, 225, 251, 267, 292]
)

secs_h5_beg_points = np.array(
    [
        0,
        17,
        18,
